...
const OVERVIEW_LINKS = [{href:"/models",labelKey:"header.nav.models"},{href:"/guides",labelKey:"header.nav.guides"},{href:"/templates",labelKey:"header.nav.templates"},{href:"/profile/account",labelKey:"profile.userMenu.account"}] as const;
