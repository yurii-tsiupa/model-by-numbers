    ...
    <div className="flex min-h-[520px] items-center justify-center rounded-3xl border border-[var(--border)] bg-[var(--card)] px-6 py-12">
      <div className="max-w-xl text-center">
        ...
        <div className="mt-8 inline-flex items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--bg)] px-3 py-1.5">
          ...
          <span className="font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.14em] text-[var(--text-secondary)]">
            {t("models.ready")}
          </span>
        </div>

        <h2 className="mt-6 font-[family-name:var(--font-display)] text-3xl font-semibold tracking-[-0.03em] text-[var(--text)]">
          {t("models.emptyTitle")}
        </h2>

        <p className="mx-auto mt-4 max-w-md font-[family-name:var(--font-body)] text-base leading-7 text-[var(--text-secondary)]">
        ...
        <button
          ...
          className="mt-10 inline-flex min-h-12 cursor-pointer items-center justify-center gap-2 rounded-xl bg-[var(--accent)] px-6 py-3 font-[family-name:var(--font-body)] text-sm font-semibold text-[var(--accent-foreground)] transition-opacity hover:opacity-90"
        >
