  ...
  return <section className="border-b border-[var(--border)] bg-[var(--bg)]">
    <div className="mx-auto w-full max-w-[1440px] px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-2xl"><p className="mb-5 font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-[0.16em] text-[var(--accent)]">{t("models.workspace")}</p><h1 className="font-[family-name:var(--font-display)] text-3xl font-semibold tracking-[-0.035em] text-[var(--text)] sm:text-4xl lg:text-[2.75rem]">{t("models.title")}</h1><p className="mt-4 max-w-xl font-[family-name:var(--font-body)] text-sm leading-6 text-[var(--text-secondary)] sm:text-base sm:leading-7">{t("models.description")}</p></div>
