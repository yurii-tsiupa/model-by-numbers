...
export type PaintingStage = { id: string; order: number; type: PaintingStageType; customName: string | null; paletteColorId: string | null; recommendedCoats: number | null; notes: string; createdAt: string; updatedAt: string };
