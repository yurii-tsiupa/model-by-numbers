...
type ModelEditorState = {
  ...
  manualDetailPlacement:{detailId:string|null;name:string;proposedMarkerNumber:number;pins:ManualDetailPin[]}|null;
...
export const useModelEditorStore =
  create<ModelEditorState>()((set) => ({
    ...
    startManualDetailPlacement:(name,detailId)=>set(state=>{
      ...
      return{manualDetails,manualDetailPlacement:{detailId:detailId??null,name:name.trim(),proposedMarkerNumber,pins:[]},regionPlacement:null,selectedManualDetailId:detailId??null,selectedManualDetailPinId:null,...(detailId?{selectedPartId:null}:{})};
    }),
