    ...
    <header className="border-b border-white/10 bg-neutral-950/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-6 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          {onDelete ? <button type="button" disabled={isGenerating} onClick={onDelete} className="inline-flex cursor-pointer items-center justify-center rounded-full border border-red-400/20 px-4 py-2.5 text-sm font-medium text-red-300 hover:bg-red-400/10">Delete Guide</button> : null}
        </div>
