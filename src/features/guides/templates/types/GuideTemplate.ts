...
export type GuidePdfTemplateComponentProps = { brandQrImageUrl?: string | null; guide: ModelGuide; viewModel?: GuideViewModel; templateSettings?: GuideTemplateSettings; renderMode?: import("../../pdf/GuidePdfRenderModeContext").GuidePdfRenderMode; sectionSelection?: import("../../pdf/ModelGuideDocument").GuidePdfSectionSelection };
