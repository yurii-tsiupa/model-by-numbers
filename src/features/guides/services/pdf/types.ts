...
export type ExportGuidePdfOptions={viewModel:GuideViewModel;templateSettings:GuideTemplateSettings;existingBlob?:Blob|null;fileName?:string;onProgress?:(progress:PdfExportProgress)=>void;onImageWarning?:(warning:PdfExportWarning)=>void;beforeDownload?:(result:PdfExportSuccess)=>Promise<void>|void};
